...
from shejianplus.config import BASE_DIR, DEFAULT_PROJECT_DIR, MODEL_FILES
from shejianplus.core.keypoint_schema import TARGET_ARCHERY, TARGET_HUMAN
...
from shejianplus.ui.widgets.annotation_canvas import AnnotationCanvas
